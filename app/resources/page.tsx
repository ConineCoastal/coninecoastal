  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-coastal-navy font-serif">For Home Buyers</CardTitle>
                <CardDescription>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-coastal-navy font-serif">For Home Sellers</CardTitle>
                <CardDescription>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-coastal-navy mb-4">Featured Resources</h2>
            <p className="text-lg text-coastal-grey">Our most popular guides and tools for First Coast property owners</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <CardTitle className="text-coastal-navy font-serif">Market Intelligence</CardTitle>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-coastal-grey">Monthly market reports</span>
                    <Button variant="outline" size="sm" asChild>
                      <Link href="/resources/market-updates">View Reports</Link>
                    </Button>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-coastal-grey">Neighborhood analysis</span>
                    <Button variant="outline" size="sm" asChild>
                      <Link href="/resources/market-updates">Explore Areas</Link>
                    </Button>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-coastal-grey">Investment insights</span>
                    <Button variant="outline" size="sm" asChild>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-coastal-grey">Renovation ROI calculator</span>
                    <Button variant="outline" size="sm" asChild>
                      <Link href="/resources/renovation-planning">Calculate</Link>
                    </Button>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-coastal-grey">Home affordability tool</span>
                    <Button variant="outline" size="sm" asChild>
                      <Link href="/resources/buyers-guide">Use Tool</Link>
                    </Button>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-coastal-grey">Improvement cost estimator</span>
                    <Button variant="outline" size="sm" asChild>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-coastal-navy mb-4">Latest Insights</h2>
              <p className="text-lg text-coastal-grey">Expert advice and market updates from the First Coast</p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <CardTitle className="text-coastal-navy font-serif text-lg">First Coast Market Trends - Q4 2024</CardTitle>
