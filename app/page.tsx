    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          ...
          <h1
            className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-6 sm:mb-8 drop-shadow-2xl"
            style={{ fontFamily: "serif" }}
          >
            Where Real Estate Meets Construction Expertise
          </h1>
          <p className="text-lg sm:text-xl lg:text-3xl text-white/95 mb-6 sm:mb-8 leading-relaxed drop-shadow-lg px-2">
            The only service in Northeast Florida combining 20 years of construction experience with professional real
            estate expertise
          </p>
          <p className="text-base sm:text-lg lg:text-xl text-white/90 mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed drop-shadow-lg px-2">
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="space-y-6 order-1 md:order-2">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-[#18457C] mb-2">Real Estate Expertise</h3>
              ...
              <div className="flex items-start space-x-4">
                <CheckCircle className="h-6 w-6 text-[#229FD9] mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-[#18457C] mb-2">Construction Knowledge</h3>
                  <p className="text-[#707070] text-sm sm:text-base">
              ...
              <div className="flex items-start space-x-4">
                <CheckCircle className="h-6 w-6 text-[#229FD9] mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-[#18457C] mb-2">End-to-End Service</h3>
                  <p className="text-[#707070] text-sm sm:text-base">
      ...
      {/* Services Overview */}
      <section className="py-16 sm:py-20 bg-gradient-to-r from-[#18457C]/5 to-[#229FD9]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#18457C] mb-6" style={{ fontFamily: "serif" }}>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
            ...
            <Card className="border-2 border-[#229FD9]/20 hover:border-[#229FD9] transition-all duration-300 hover:shadow-xl">
              <CardContent className="p-6 sm:p-8">
                ...
                <p className="text-[#707070] mb-6 text-base sm:text-lg leading-relaxed">
            ...
            {[
              ...
              >
                <CardContent className="p-6 sm:p-8">
                  ...
                  <h3
                    className="text-xl sm:text-2xl font-bold text-[#18457C] mb-3 sm:mb-4"
                    style={{ fontFamily: "serif" }}
                  >
                    {benefit.title}
                  </h3>
            ...
            {[
              ...
              >
                <CardContent className="p-6 sm:p-8">
                  ...
                  <p className="text-[#707070] mb-4 italic leading-relaxed text-sm sm:text-base">
                    "{testimonial.text}"
                  </p>
                  <div>
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-20 bg-gradient-to-r from-[#18457C] to-[#229FD9]">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6" style={{ fontFamily: "serif" }}>
            Ready to Get Started?
          </h2>
          <p className="text-lg sm:text-xl text-white/90 mb-8 sm:mb-12 leading-relaxed px-2">
