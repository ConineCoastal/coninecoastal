...
export default function PropertyManagementClientPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      icon: <Wrench className="h-8 w-8 text-coastal-blue" />,
      description:
    ...
    },
    {
      ...
      icon: <Search className="h-8 w-8 text-coastal-blue" />,
      description:
    ...
    },
    {
      ...
      icon: <Settings className="h-8 w-8 text-coastal-blue" />,
    ...
    },
    {
      ...
      icon: <Mail className="h-8 w-8 text-coastal-blue" />,
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        <Image
          src="https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?auto=format&fit=crop&w=1920&h=1080&q=80"
          alt="Well-maintained rental property in Northeast Florida"
          fill
          priority
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          <Badge className="mb-6 bg-coastal-blue text-white px-6 py-3 text-lg shadow-lg">
          ...
          <Button size="lg" className="bg-coastal-orange hover:bg-coastal-orange/90 text-white px-10 py-4 text-xl shadow-2xl">
            ...
            <Card className="text-center border-2 border-coastal-blue/20 hover:border-coastal-blue transition-all duration-300 hover:shadow-xl">
              <CardContent className="p-8">
                <div className="w-20 h-20 bg-coastal-blue/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <Wrench className="h-10 w-10 text-coastal-blue" />
                </div>
            ...
            <Card className="text-center border-2 border-coastal-orange/20 hover:border-coastal-orange transition-all duration-300 hover:shadow-xl">
              <CardContent className="p-8">
                <div className="w-20 h-20 bg-coastal-orange/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <MapPin className="h-10 w-10 text-coastal-orange" />
                </div>
                <h3 className="text-2xl font-bold text-coastal-navy mb-4 font-serif">
            ...
            <Card className="text-center border-2 border-coastal-yellow/20 hover:border-coastal-yellow transition-all duration-300 hover:shadow-xl">
              <CardContent className="p-8">
                <div className="w-20 h-20 bg-coastal-yellow/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <Shield className="h-10 w-10 text-coastal-yellow" />
                </div>
                <h3 className="text-2xl font-bold text-coastal-navy mb-4 font-serif">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <Card
                key={index}
                className="hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-2 border-gray-100 hover:border-coastal-blue/30"
              >
                <CardContent className="p-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-coastal-grey text-sm leading-relaxed">{service.description}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-5xl mx-auto">
              ...
              <CardContent className="p-0">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-coastal-navy text-white">
                      <tr>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      <tr className="hover:bg-gray-50">
                        <td className="px-6 py-4 font-semibold text-coastal-navy">Monthly Management</td>
                        <td className="px-6 py-4 text-coastal-blue font-bold">8% of collected rent</td>
                        <td className="px-6 py-4 text-coastal-grey">
                          Full-service management, tenant placement, maintenance coordination
                        </td>
                      </tr>
                      <tr className="hover:bg-gray-50">
                        <td className="px-6 py-4 font-semibold text-coastal-navy">Tenant Placement Only</td>
                        <td className="px-6 py-4 text-coastal-blue font-bold">One month's rent</td>
                        <td className="px-6 py-4 text-coastal-grey">
                          Screening, placement, lease preparation (no ongoing management)
                        </td>
                      </tr>
                      <tr className="hover:bg-gray-50">
                        <td className="px-6 py-4 font-semibold text-coastal-navy">Maintenance & Repairs</td>
                        <td className="px-6 py-4 text-coastal-blue font-bold">Cost + 0% markup</td>
                        <td className="px-6 py-4 text-coastal-grey">
            ...
            <div className="mt-8 text-center">
              <p className="text-coastal-grey italic">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                {advantages.map((advantage, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    ...
                    <p className="text-coastal-grey text-lg">{advantage}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="relative">
              <Image
                src="https://images.unsplash.com/photo-1560185127-6ed189bf02f4?auto=format&fit=crop&w=800&h=600&q=80"
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-lg shadow-lg border">
                <div className="text-2xl font-bold text-coastal-blue mb-1">8%</div>
            ...
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-white hover:shadow-lg transition-shadow">
                <CardContent className="p-8">
                  ...
                  <p className="text-coastal-grey mb-6 italic">"{testimonial.text}"</p>
                  <div>
                    <p className="font-semibold text-coastal-navy">{testimonial.name}</p>
                    <p className="text-sm text-coastal-grey">{testimonial.title}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {serviceAreas.map((area, index) => (
              <div key={index} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                <MapPin className="h-5 w-5 text-coastal-blue flex-shrink-0" />
                <span className="text-coastal-grey">{area}</span>
              </div>
            ))}
          </div>

          <div className="text-center mt-8">
            <p className="text-coastal-grey italic">Contact us to confirm service availability in your specific area.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-coastal-navy/5 to-coastal-blue/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <Card className="text-center border-2 border-coastal-blue/20 hover:border-coastal-blue transition-all duration-300">
              <CardContent className="p-8">
                <div className="w-16 h-16 bg-coastal-blue text-white rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold">
                  1
                </div>
                <h3 className="text-2xl font-bold text-coastal-navy mb-4 font-serif">
            ...
            <Card className="text-center border-2 border-coastal-orange/20 hover:border-coastal-orange transition-all duration-300">
              <CardContent className="p-8">
                <div className="w-16 h-16 bg-coastal-orange text-white rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold">
                  2
                </div>
                <h3 className="text-2xl font-bold text-coastal-navy mb-4 font-serif">
                  Management Agreement
                </h3>
                <p className="text-coastal-grey leading-relaxed">Simple, transparent agreement with competitive rates</p>
              </CardContent>
            </Card>

            <Card className="text-center border-2 border-coastal-yellow/20 hover:border-coastal-yellow transition-all duration-300">
              <CardContent className="p-8">
                <div className="w-16 h-16 bg-coastal-yellow text-white rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold">
                  3
                </div>
                <h3 className="text-2xl font-bold text-coastal-navy mb-4 font-serif">
                  Full-Service Management
                </h3>
                <p className="text-coastal-grey leading-relaxed">We handle everything while you collect rent checks</p>
              </CardContent>
            </Card>
          </div>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-coastal-grey">(555) 123-4567</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-coastal-grey">properties@coninecoastal.com</p>
                  </div>
                </div>
              </div>

              <div className="mt-8">
                <Button className="bg-coastal-blue hover:bg-coastal-blue/90 text-white px-6 py-3">
              ...
              <CardContent className="p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-coastal-navy mb-1">Email *</label>
                      <Input
                        type="email"
                        name="email"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-coastal-navy mb-1">Phone Number</label>
                    <Input
                      type="tel"
                      name="phone"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-coastal-navy mb-1">Property Address</label>
                    <Input
                      type="text"
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-coastal-navy mb-1">Property Type</label>
                      <select
                        name="propertyType"
                        value={formData.propertyType}
                        onChange={handleInputChange}
                        className="w-full px-3 py-2 border border-coastal-grey/30 rounded-md focus:border-coastal-blue focus:outline-none"
                      >
                    ...
                    <div>
                      <label className="block text-sm font-medium text-coastal-navy mb-1">Current Status</label>
                      <select
                        name="currentStatus"
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-coastal-navy mb-1">Current Monthly Rent</label>
                      <Input
                        type="text"
                        name="currentRent"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-coastal-navy mb-1">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-coastal-navy mb-1">Additional Comments</label>
                    <Textarea
                      name="comments"
